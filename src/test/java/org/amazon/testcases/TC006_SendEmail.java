...
//		@Test
	    public void sendEmail() throws IOException {
	        ...
	        String port = "587";
	        String mailFrom = PropertyReader.configReader("SenderAddress");
	        String password = PropertyReader.configReader("SenderPassword");
	 
	        // message info
	        String mailTo = PropertyReader.configReader("RecipientsAddress");
